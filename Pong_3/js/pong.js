...
function draw() {
    background(0);
    text("Digital Pong", 300, 20);
    text("Move your arrow keys up and down to move your paddle and hit the ball. Whoever gets to 10 first wins the game.",40,height-10);
    //We want to check for winners, and if someone has won, stop the game.
    if (p1Score == winningScore) {
        //display win message for player 1
        text("You win! Click the screen to start a new game.", 300,225);

         /*  Add "play again" button? This just could reset the 
         *  p1 and p2 scores and it would work using this code.
         * add a shape and put it at the center of the screen. when that shape is clicked, make 
         * p1 = 0 and p2=0. 
         */

    } else if (p2Score == winningScore) {
        //display win message for player 2
        text("You lose! Click the screen to start a new game.", 300, 255);
